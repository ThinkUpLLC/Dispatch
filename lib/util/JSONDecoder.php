...
class JSONDecoder {
    ...
    public static function decode($json, $assoc = false) {
        ...
        if (!empty($error)) {
            throw new \thinkup\exceptions\JSONDecoderException('JSON Error: '.$error);
        } elseif ($result === null) {
            throw new thinkup\exceptions\JSONDecoderException('JSON Error decoding data');
        }
        return $result;
    }
}